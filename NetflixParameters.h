...
int matrix_rank[N_energy_bins] = {1,3,3,3,2,2,2,1,1,1,1};
int cr_correction_xyoff_bins[N_energy_bins] = {20,20,20,10,10,3,3,1,1,1,1};

double method_ratio_mean[N_energy_bins] =        {1.000,0.001,0.007,0.010,0.008,0.011,0.011,0.005,0.001,0.078,-0.006};
double method_pertrubation_mean[N_energy_bins] = {1.000,-0.002,0.009,0.015,0.021,0.024,0.044,0.005,0.001,0.078,-0.006};
double method_regression_mean[N_energy_bins] =   {1.000,-0.014,0.002,-0.001,0.006,0.011,-0.001,-0.029,-0.101,0.012,0.238};
double method_ratio_rms[N_energy_bins] =         {1.000,0.064,0.065,0.055,0.052,0.050,0.070,0.103,0.163,0.312,0.345};
double method_pertrubation_rms[N_energy_bins] =  {1.000,0.034,0.049,0.047,0.047,0.048,0.093,0.103,0.163,0.312,0.345};
